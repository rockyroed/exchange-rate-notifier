...
def main():
    ...
    is_above_threshold = check_exchange_rate(rates, CURRENCY, THRESHOLD)

    if is_above_threshold:
        print(f"The current exchange rate is ₱{rates[CURRENCY]}. It is above the threshold ₱{THRESHOLD}.")
        ...
        print(f"The current exchange rate is ₱{rates[CURRENCY]}. It is below the threshold ₱{THRESHOLD}.")
